...
// Added "strconv" package to "net" deps for Go 1.5
//
...
var pkgDeps = map[string][]string{
	...
	"net": {"L0", "CGO", "math/rand", "os", "sort", "syscall", "time", "internal/syscall/windows", "internal/singleflight", "internal/race", "strconv"}, // Added "strconv"
